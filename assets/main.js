...
(function () {
  ...
  /* ============================================================================ */
  // MARK: Update Day Gap
  function updateDayGap() {
    let startTime = new Date("2021/4/22");
    let endTime = new Date();
    let usedTime = endTime.getTime() - startTime.getTime();
    let days = usedTime / (24 * 36) / 100000;
    document.getElementById("day-created").innerHTML = Math.floor(days);
  }
  ...
  /* all: setInterval(updateDayGap, 200); */
  ...
  function changeScrollToTopButtonVisible(scrollPos) {
    if (scrollPos > 100) {
  ...
  document.addEventListener("scroll", function (e) {
    ...
    if (!ticking) {
      window.requestAnimationFrame(function () {
        changeScrollToTopButtonVisible(lastKnownScrollPosition);
        ticking = false;
      });
